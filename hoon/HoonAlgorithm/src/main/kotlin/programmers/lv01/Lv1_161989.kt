 ...
 * 다시 칠해야 할 구역이 아닌 곳에 페인트를 칠해도 되지만
 * 다시 칠하기로 정한 구역은 적어도 한 번 페인트칠을 해야 합니다.
 * 예산을 아끼기 위해 다시 칠할 구역을 정했듯
 ...
 * 처음에 3, 4, 5, 6번 영역에 페인트칠을 하면 칠해야 할 곳으로
 * 2번 구역만 남고 1, 2, 3, 4번 구역에 페인트칠을 하면
 ...
 * 롤러의 길이가 4미터이므로 한 번의 페인트칠에 연속된 4개의 구역을 칠할 수 있고
 * 1, 2, 3, 4번 영역에 페인트칠을 하면
 * 한 번에 1, 3번 영역을 모두 칠할 수 있습니다.
 * [img2.png]
